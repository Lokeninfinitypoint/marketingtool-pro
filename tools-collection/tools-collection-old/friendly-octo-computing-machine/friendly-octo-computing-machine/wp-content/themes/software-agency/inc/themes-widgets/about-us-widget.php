...
class Software_Agency_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Software_Agency_About_Widget',
			__('VW About us', 'software-agency'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'software-agency' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','software-agency'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','software-agency'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','software-agency'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','software-agency'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','software-agency'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','software-agency'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function software_agency_about_custom_load_widget() {
	register_widget( 'Software_Agency_About_Widget' );
}
add_action( 'widgets_init', 'software_agency_about_custom_load_widget' );