jQuery(document).ready(function($) {
    'use strict';
    var this_obj = software_agency_plugin_activate_plugin;   

    $(document).on('click', '.software-agency-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message software-agency-plugin-install');
                button.addClass('button-primary software-agency-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.software-agency-recommended-plugins .software-agency-activation-note').css('display','block');
    ...
    $(document).on('click', '.software-agency-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .software-agency-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .software-agency-recommended-plugins').css('display','none');
    });
