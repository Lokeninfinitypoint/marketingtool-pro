          ...
          <?php if( get_theme_mod( 'software_agency_toggle_postdate',true) == 1 || get_theme_mod( 'software_agency_toggle_author',true) == 1 || get_theme_mod( 'software_agency_toggle_comments',true) == 1 || get_theme_mod( 'software_agency_toggle_time',true) == 1) { ?>
            <div class="post-info p-2 mb-3">
              <?php if(get_theme_mod('software_agency_toggle_postdate',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('software_agency_toggle_postdate_icon','fas fa-calendar-alt')); ?>"></i><span class="entry-date"><a href="<?php echo esc_url( get_day_link( $software_agency_archive_year, $software_agency_archive_month, $software_agency_archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><span><?php echo esc_html(get_theme_mod('software_agency_meta_field_separator', '|'));?></span>
              <?php } ?>

              <?php if(get_theme_mod('software_agency_toggle_author',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('software_agency_toggle_author_icon','fas fa-user')); ?>"></i><span class="entry-author"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span><span><?php echo esc_html(get_theme_mod('software_agency_meta_field_separator', '|'));?></span>
              <?php } ?>

              <?php if(get_theme_mod('software_agency_toggle_comments',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('software_agency_toggle_comments_icon','fa fa-comments')); ?>" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'software-agency'), __('0 Comments', 'software-agency'), __('% Comments', 'software-agency') ); ?></span><span><?php echo esc_html(get_theme_mod('software_agency_meta_field_separator', '|'));?></span>
              <?php } ?>

              <?php if(get_theme_mod('software_agency_toggle_time',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('software_agency_toggle_time_icon','fas fa-clock')); ?>"></i><span class="entry-time"><?php echo esc_html( get_the_time() ); ?></span>
              <?php } ?>
          ...
          <p class="mb-0">
            ...
            if($software_agency_theme_lay == 'Excerpt'){ ?>
              <?php if(get_the_excerpt()) { ?>
                <?php $software_agency_excerpt = get_the_excerpt(); echo esc_html( software_agency_string_limit_words( $software_agency_excerpt, esc_attr(get_theme_mod('software_agency_excerpt_number','30')))); ?> <?php echo esc_html(get_theme_mod('software_agency_blog_excerpt_suffix',''));?>
              <?php }?>
            <?php }?>
          </p>
