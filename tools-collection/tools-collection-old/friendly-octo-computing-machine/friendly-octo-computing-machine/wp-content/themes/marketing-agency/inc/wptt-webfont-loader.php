...
if ( ! class_exists( 'Marketing_Agency_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Marketing_Agency_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'marketing_agency_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function marketing_agency_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Marketing_Agency_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'marketing_agency_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function marketing_agency_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Marketing_Agency_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
