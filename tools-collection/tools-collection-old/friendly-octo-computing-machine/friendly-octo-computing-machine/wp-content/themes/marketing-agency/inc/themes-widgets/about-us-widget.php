...
class Marketing_Agency_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Marketing_Agency_About_Widget',
			__('VW About us', 'marketing-agency'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'marketing-agency' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','marketing-agency'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','marketing-agency'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','marketing-agency'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','marketing-agency'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','marketing-agency'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','marketing-agency'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function marketing_agency_about_custom_load_widget() {
	register_widget( 'Marketing_Agency_About_Widget' );
}
add_action( 'widgets_init', 'marketing_agency_about_custom_load_widget' );