			...
			<Suspense fallback={ <Spinner /> }>
				...
				{ showIndividual && (
					<div className="neve-white-background-control">
						<span>
							{ __( 'Available shortcode:', 'neve-pro-addon' ) }
						</span>
						<Button
							className="short-code"
							icon="welcome-write-blog"
							label={ __( 'Copy shortcode', 'neve-pro-addon' ) }
							showTooltip={ true }
							isSmall
							onClick={ async () => {
				...
				<Toggle
					label={ __( 'Enable expiration date', 'neve-pro-addon' ) }
				...
				{ ( showHooks || showSidebar ) && (
					<NumberInputComponent
						label={ __( 'Priority', 'neve-pro-addon' ) }
						defaultValue={ 10 }
