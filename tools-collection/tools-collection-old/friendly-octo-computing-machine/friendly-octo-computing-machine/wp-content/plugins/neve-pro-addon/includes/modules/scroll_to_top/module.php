...
class Module extends Abstract_Module {
	...
	public function setup_labels() {
		$this->name          = __( 'Scroll To Top', 'neve-pro-addon' );
		$this->description   = __( 'Add a customizable scroll-to-top button that appears exactly when needed. Style it to match your brand.', 'neve-pro-addon' );
	...
	public function render_button() {
		...
		echo '<button tabindex="0"' . esc_attr( $amp ) . ' id="scroll-to-top" class="scroll-to-top ' . esc_attr( $extra_class ) . '" aria-label="' . esc_attr__( 'Scroll to Top', 'neve-pro-addon' ) . '">';
		if ( $type === 'icon' ) {
