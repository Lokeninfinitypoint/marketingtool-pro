...
class Module extends Abstract_Module {
	...
	public function setup_labels() {
		...
		$this->description   = __( 'Advanced layouts, reading time estimates, and social sharing to keep readers engaged longer.', 'neve-pro-addon' );
	...
	public function get_read_more_args() {
		...
		$rm_style = get_theme_mod( 'neve_read_more_style', Loader::is_new_user_after_theme_v4() ? 'none' : 'text' );
		...
		$read_more_classes = '';
		if ( $rm_style === 'primary_button' ) {
			$read_more_classes = 'button button-primary';
		}
		if ( $rm_style === 'secondary_button' ) {
